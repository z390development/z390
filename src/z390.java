...
public  class  z390
    ...
    private void about_command() {
        ...
        put_log("  * z390 distributed as zip file for Windows/Linux/Mac");
        put_log("  * z390 includes example demos and regression tests");
        put_log("  * z390 written entirely in J2SE 1.8.0 compatible Java");
     ...
     * @param cmd_parm string of decimal digits
        ...
        try {
            if (cmd_parm.charAt(0) == '\''
                ...
                while (index1 < cmd_parm.length() - 1) {
                    work_int = work_int * 256 + get_text_char(cmd_parm.charAt(index1));
                    index1++;
                }
            } else {
    ...
    protected void displayInfo(KeyEvent e, String s) {
        ...
        // You should only rely on the key char
        // if the event is a key typed event.
        int id = e.getID();
    ...
    private void create_select_dir(final JFileChooser select_dir_chooser) {
        ...
        select_dir_chooser.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (state.equals(JFileChooser.APPROVE_SELECTION)) { // RPI 541
        ...
        try {
            ...
            while (cmd_exec_output_msg != null) {
                if (cmd_exec_output_msg.equals("exit_request")) {
                    // if ez390 issues exit request to close down
                    // gui this is triggered when ez390 exits if
