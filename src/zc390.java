...
public class zc390 {
    ...
    private class section_definition {                                                                                     // #655
        ...
        section_definition(String section_specification) throws zCobolException {                                          // #655
            ...
            try {                                                                                                          // #655
                my_sequence_id=Integer.parseInt(section_specification.substring(0,i));  // extract seq nr                  // #655
        ...
        while (!zc_eof
            ...
            if  (zc_line != null) {
                if (zc_copy_trailer) {
                    ...
                    if (zc_proc_div) {
                        zc_token_match = zc_proc_token_pattern.matcher(zc_line.substring(7));
                    } else {
                        zc_token_match = zc_data_token_pattern.matcher(zc_line.substring(7));
                    }
                    zc_match_offset = 8;
                }
                find_next_token();
