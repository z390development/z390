#!/bin/bash
# az390: execute az390 runtime with java runtime options:
...
java -classpath ${jardir}/z390.jar -Xrs $J2SEOPTIONS az390 $1 $2 $3 $4 $5 $6 $7 $8 $9

rc=$?
if [ $debug -eq 1 ]; then echo "az390 after java command; rc=$rc"; fi
