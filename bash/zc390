#!/bin/bash
# zc390: execute zc390 to translate CBL source file to MCL file with zcobol macro calls
...
java -classpath ${jardir}/z390.jar -Xrs zc390 $1 $2 $3 $4 $5 $6 $7 $8 $9

rc=$?
if [ $debug -eq 1 ]; then echo "zc390 after java command; rc=$rc"; fi
