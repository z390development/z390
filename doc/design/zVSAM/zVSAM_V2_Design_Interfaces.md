...
For details please see the [ACB chapter in the Addenda](zVSAM_V2_Design_Addenda.md#acb-details).
...
**Note 1:** Option RRN for access to RRDS was defined by Melvyn, but is not documented for IBM VSAM.
